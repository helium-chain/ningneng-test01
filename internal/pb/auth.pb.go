...
func (x *LoginResponse) GetAccount() string {
	if x, ok := x.GetResponse().(*LoginResponse_Account); ok {
		return x.Account
	}
	return ""
}
...
func (*LoginResponse_Account) isLoginResponse_Response() {}
...
func (x *InfoResponse) GetAccount() string {
	if x != nil {
		return x.Account
	}
	return ""
...
var file_auth_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x12, 0x1a, 0x0a, 0x07, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x01, 0x20,
	...
	0x73, 0x65, 0x22, 0x4e, 0x0a, 0x0c, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	...
	0x67, 0x65, 0x32, 0x6b, 0x0a, 0x0f, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x4d, 0x61, 0x6e, 0x61, 0x67,
	0x65, 0x6d, 0x65, 0x6e, 0x74, 0x12, 0x26, 0x0a, 0x05, 0x6c, 0x6f, 0x67, 0x69, 0x6e, 0x12, 0x0d,
	...
	0x07, 0x67, 0x65, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x16, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c,
...
var file_auth_proto_depIdxs = []int32{
	0, // 0: OrderManagement.login:input_type -> LoginRequest
	3, // 1: OrderManagement.getInfo:input_type -> google.protobuf.Empty
	1, // 2: OrderManagement.login:output_type -> LoginResponse
	2, // 3: OrderManagement.getInfo:output_type -> InfoResponse
